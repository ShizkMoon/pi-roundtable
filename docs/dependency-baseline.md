...
| --- | --- | --- |
| Oh My Pi | release `v17.2.2`; RPC docs at commit `8baa3300bc23c721fc80c0307f0b7a8218be8fcb` | Use the public stdio JSONL protocol rather than private packages. Protocol v2 supports lossless chunking. |
